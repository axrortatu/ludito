...
public class JwtService {
    ...
    public String generateAccessToken(AgentEntity userDetails) throws JsonProcessingException {
    ...
    public String generateRefreshToken(AgentEntity userDetails) throws JsonProcessingException {
        Date currentTime = new Date();
        return Jwts.builder()
                .subject(userDetails.getUsername())
                .issuedAt(currentTime)
